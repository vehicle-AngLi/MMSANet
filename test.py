...
def main(ir_dir='./test_imgs/ir', vi_dir='./test_imgs/vi', save_dir='./Save', fusion_model_path='./model/Fusion/fusionmodel_final.pth'):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Start Pre-trained RCAFusion successfully!')
    ## model
    parser.add_argument('--model_path', '-M', type=str, default='./model/fusion.pth')
    ## dataset
    ...
    print('| testing %s on GPU #%d with pytorch' % ('RCAFusion', args.gpu))
